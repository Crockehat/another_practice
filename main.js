$(document).ready(function () {
  ...
  const defaultProducts = [
    ...
    { id: 102, name: "Кружка с надписью", price: 450, description: "Керамика, оригинальный дизайн", img: "img/медея.jpg", category: "Кружки", material: "Керамика", manufacturer: "CeramicArt", country: "Россия", details: "Объем: 400 мл", composition: ["Керамика", "Термостойкая глазурь"] },
    { id: 103, name: "Керамическая кружка", price: 550, description: "Ручная работа", img: "img/медея.jpg", category: "Кружки", material: "Керамика", manufacturer: "HandMade Studio", country: "Россия", details: "Объем: 300 мл", composition: ["Натуральная глина", "Безопасная глазурь"] },
    ...
    { id: 105, name: "Сервиз 'Восточный'", price: 4200, description: "Роспись подглазурная", img: "img/медея.jpg", category: "Чайный сервиз", material: "Фарфор", manufacturer: "OrientalTea", country: "Китай", details: "6 персон, 18 предметов", composition: ["Твердый фарфор", "Подглазурная роспись"] },
    { id: 106, name: "Эспрессо чашка", price: 280, description: "Классическая форма", img: "img/медея.jpg", category: "Чашки для кофе", material: "Фарфор", manufacturer: "CoffeeLover", country: "Польша", details: "Объем: 80 мл", composition: ["Тонкостенный фарфор"] },
    { id: 107, name: "Капучино чашка", price: 320, description: "Объем 250 мл", img: "img/медея.jpg", category: "Чашки для кофе", material: "Керамика", manufacturer: "CoffeeLover", country: "Польша", details: "Объем: 250 мл", composition: ["Керамика", "Толстые стенки"] },
    { id: 108, name: "Детский набор 'Зверята'", price: 890, description: "Тарелка, кружка, ложка", img: "img/медея.jpg", category: "Детская посуда", material: "Маламиновая пластмасса", manufacturer: "KidsJoy", country: "Китай", details: "3 предмета", composition: ["Безопасная пластмасса", "Рисунки зверят"] },
    { id: 109, name: "Детская кружка с крышкой", price: 420, description: "Небьющаяся, с трубочкой", img: "img/медея.jpg", category: "Детская посуда", material: "Пластик", manufacturer: "KidsJoy", country: "Китай", details: "Объем: 200 мл", composition: ["Пищевой пластик", "Силиконовая трубочка"] },
    { id: 110, name: "Подарочный набор 'Вечерний чай'", price: 2850, description: "2 кружки, чай, конфеты", img: "img/медея.jpg", category: "Наборы", material: "Фарфор", manufacturer: "GiftMaster", country: "Россия", details: "2 кружки + чай + конфеты", composition: ["Фарфор", "Цейлонский чай", "Шоколадные конфеты"] },
    { id: 111, name: "Набор для кофе", price: 1950, description: "2 чашки, кофе, ложки", img: "img/медея.jpg", category: "Наборы", material: "Керамика", manufacturer: "GiftMaster", country: "Россия", details: "2 чашки + кофе + ложки", composition: ["Керамика", "Молотый кофе", "Металлические ложки"] },
    { id: 112, name: "Сувенирная кружка 'Горы'", price: 590, description: "С 3D эффектом", img: "img/медея.jpg", category: "Сувенирная посуда", material: "Керамика", manufacturer: "SouvenirShop", country: "Китай", details: "Объем: 350 мл", composition: ["Керамика", "3D-печать"] },
    { id: 113, name: "Кружка-хамелеон", price: 680, description: "Меняет цвет от температуры", img: "img/медея.jpg", category: "Сувенирная посуда", material: "Керамика", manufacturer: "MagicMug", country: "Китай", details: "Объем: 300 мл", composition: ["Термочувствительная краска", "Керамика"] },
    { id: 114, name: "Термокружка 500мл", price: 1250, description: "Нержавеющая сталь", img: "img/медея.jpg", category: "Термосы", material: "Нержавеющая сталь", manufacturer: "ThermoKing", country: "Китай", details: "Объем: 500 мл, двойные стенки", composition: ["Нержавеющая сталь 304", "Вакуумная изоляция"] },
    { id: 115, name: "Термос 1л", price: 1890, description: "Двойные стенки", img: "img/медея.jpg", category: "Термосы", material: "Нержавеющая сталь", manufacturer: "ThermoKing", country: "Китай", details: "Объем: 1 л, двойные стенки", composition: ["Нержавеющая сталь 304", "Вакуумная изоляция"] }
  ];
